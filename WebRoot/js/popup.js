...
build:function(){
   ...
   //var close='<input type="img" id="dialogBoxClose" src="'+path+'dialogclose.gif" border="0" width="16" height="16" align="absmiddle" title="鍏抽棴"/>';
   var close='<img id="dialogBoxClose" title="鍏抽棴" src=/hzpxs/img/dialogclose.gif  />';
