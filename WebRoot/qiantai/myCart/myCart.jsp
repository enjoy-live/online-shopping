...
名称</td>
	        				...
	        				<table>
			                   ...
			                   <tr>
			                       <td width="120"></td>
			                       <td><input type="button" value="清空购物车" onclick="clearCart()"/></td>
			                       <td><input type="button" value="继续购物" onclick="jixu()"/></td>
			                       <td><input type="button" value="去收银台" onclick="orderQueren()"/></td>
			                   </tr>
			               </table>
					</div>
				</div>
